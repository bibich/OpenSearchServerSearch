...
namespace OpenSearchServerSearch\Hook;
...
class FrontHook extends BaseHook
{
    ...
    {
        $event->add($this->addJS('assets/js/jquery.autocomplete.min.js'));
    }

    public function onMainJavascriptInitialization(HookRenderEvent $event)
    {
        $event->add($this->render('main-javascript-initialization.html'));
    }
